      ...
      local opts = {
        ...
        config = {
          ...
          center = {
            ...
            { action = [[lua require("configs.utils").telescope.config_files()()]], desc = " config",           key = "c" },
            { action = 'lua require("persistence").load()',                        desc = " restore session",  key = "s" },
            { action = "edit ~/.config/hypr",                                      desc = " edit hyprland dotfiles",      key = "x" },
          ...
          footer = function()
            ...
            return { "schizonvim loaded " .. stats.loaded .. "/" .. stats.count .. " plugins in " .. ms .. "ms" }
          end,
        },
      }
